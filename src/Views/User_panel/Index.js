            ...
            {lounges?.map((item, index) => {
              ...
              return (
                <div className="lounge-session">
                  <div style={{cursor:'pointer'}}  onClick = {()=>{navigate(`/join_lounge/${item._id}`,{state:item})}} className="main-session ifjTYe">
                    <div
                      className="dTqEqv"
                      style={{
          ...
          {sortedlounges?.map((item,index)=>{
            return (
              ...
              <div className="guKkvw">
                <img src={imageURL+ item.banner} style={{cursor:'pointer'}} onClick = {()=>{navigate(`/join_lounge/${item._id}`,{state:item})}} alt="img" className="sc-kfzAmx fTLfYv" />
                <span
